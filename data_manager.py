"""
Data loading and feature engineering for Tabular Alpha Decay engine.
"""
...
def build_features(returns: pd.DataFrame, macro: pd.DataFrame) -> pd.DataFrame:
    ...
    for ticker in tickers:
        ...
        df['ret_5d'] = ret.rolling(5).mean().shift(1)
        df['ret_21d'] = ret.rolling(21).mean().shift(1)
        df['target'] = ret  # next-day return
